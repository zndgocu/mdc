...
namespace com.doosan.fms.commonLib.Encryption
{
    public static class Encryptor
    {
        public static string EncryptString(string InputText, string Password = ENCRYPTOR_PASSWORD)
        {
        ...
        // 복호화 AES256
        public static string DecryptString(string InputText, string Password = ENCRYPTOR_PASSWORD)
        {
